#    MTUOC_tokenizer_cat 6.0 version 202409
...
class Tokenizer():
    def __init__(self):
        ...
        self.subs=["d'￭","s'￭","qu'￭","mo'￭","vo'￭","l'￭","quanqu'￭","pr'￭","per'￭","t'￭","n'￭","￭'n","￭'t","￭'i","￭'m","￭'","￭'c","￭'s","￭'u","￭'les","￭'ac","￭'lo","￭'li","￭'les","￭-me","￭-te","￭-se","￭-ne","￭-lo","￭-la","￭-les","￭-mos","￭-vos","￭-li","￭-mo","￭-vo","￭-i","￭-ac","￭-ne","￭-en"]
        try:
            APOSTROPHES.remove("'")
        except:
            pass
        ...
        self.abr = ["adj.", "adm.", "ap.", "apm.", "art.", "assoc.", "av.", "bibl.", "bl.", "cap.", "cm.", "dr.", "dra.", "dpt.", "ent.", "excm.", "exma.", "gov.", "hble.", "ilm.", "ilma.", "mons.", "mtro.", "nº", "núm.", "núms.", "obs.", "p.e.", "p.ej.", "pag.", "pàg.", "pg.", "pl.", "prov.", "ptge.", "q.e.p.d.", "q.b.", "q.t.", "rbla.", "rda.","rev.", "sr.", "sra.", "srs.", "srta.", "ud.", "uds.", "vda.", "vdo.", "vol.", "vs."]
