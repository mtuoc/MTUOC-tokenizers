...
class Tokenizer():
    def __init__(self):
        ...
        self.abr=["a.c.","a.m.","art.","cc.","c.p.","d.c.","dir.","d.m.","e.a.u.","ecc.","ect.","etc.","i.e.","inc.","k.o.","min.","n.","n.d.r.","ndr.","n.d.t.","o.k.","p.es.","p.m.","p.t.","p.v.","sec.","s.l.m.","s.p.a.","s.r.l.","s.t.","st.","s.v.","sv."]
        abr_aux=[]
        for a in self.abr:
            am1=a.capitalize()
            am2=a.upper()
...
def print_help():
    print("MTUOC_tokenizer_cat.py A tokenizer for Italian, usage:")
