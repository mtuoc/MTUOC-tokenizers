#    MTUOC_tokenizer_arg 6.0 version 202409
...
class Tokenizer():
    def __init__(self):
        ...
        self.abr=["a.C.","a.d.C.","A.R.","adj.","adm.","af.","agr.","ant.","aprox.","art.","aut.","bibl.","biog.","cap.","cf.","cit.","col.","comp.","conj.","cont.","coord.","D.","def.","dir.","doc.","ed.","enc.","ens.","esp.","est.","et al.","ex.","fam.","fig.","fol.","freq.","geom.","gr.","hist.","ibid.","incl.","introd.","jur.","lat.","lit.","loc.","man.","med.","mil.","min.","mod.","mus.","nat.","n.d.","n.p.","num.","obs.","op. cit.","orig.","p.","p.ex.","pág.","part.","pers.","plur.","pref.","prep.","pres.","prof.","prov.","pto.","pub.","ref.","reg.","rel.","rev.","sec.","sig.","sing.","sub.","subj.","sup.","trad.","trans.","var.","verb.","vol.","zool.","cc.oo.","ee.uu.","j.c.","s.a.","s.l."]
        abr_aux=[]
        for a in self.abr:
            am1=a.capitalize()
            am2=a.upper()
