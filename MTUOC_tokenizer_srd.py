...
class Tokenizer():
    def __init__(self):
        ...
        self.abr=["d.m.","s.a.","u.e.a.","a.c.","ac.","apross.","art.","d.c.","dc.","n.","p.c.","p.es.","pc.","sèc.","u.","vol."]
        abr_aux=[]
        for a in self.abr:
            am1=a.capitalize()
            am2=a.upper()
...
def print_help():
    ...
    print('    cat "sentence to tokenize." | python3 MTUOC_tokenizer_srd.py tokenize')
    print('    python3 MTUOC_tokenizer_srd.py tokenize < file_to_tokenize > tokenized_file')
    print()
    print("Simple detokenization:")
    print('    cat "sentence to tokenize." | python3 MTUOC_tokenizer_srd.py detokenize')
    print('    python3 MTUOC_tokenizer_srd.py detokenize < file_to_detokenize > detokenized_file')
    print()
